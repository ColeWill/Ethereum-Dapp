App = {
  ...
  // connects the client to the blockchain 
  initWeb3: function() {
  ...
  // loads contract into the application so we can interact with it
  ...
  render: function() {
    ...
    // Load the account data we are connected to the blockhain with
    ...
    App.contracts.Election.deployed().then(function(instance) {
      ...
      return electionInstance.candidatesCount(); // keeps track of all candidates in our mapping
